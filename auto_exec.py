...
""",
        ...
        try:
            if lifecycle.stage == "IN_POSITION" and bool(getattr(cfg, "enable_time_profit_capture", False)):
                    ...
                    if (shared_last_px is None) or (not entry_px) or (entry_px <= 0):
                        ...
                        if gain_pct >= thresh_cfg:
                            ...
                            try:
                                ...
                                _append_note(lifecycle, f"TIMEOUT_PROFIT_EXIT_ERR {str(place_exc)[:240]}")
                                body_with_qty = _timeout_profit_state_block(
                                    cfg, lifecycle, now,
                                    shared_last_px=shared_last_px,
                                    entry_px=entry_px,
